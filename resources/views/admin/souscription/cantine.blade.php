                ...
                <div class="col-xl-12">
                    <div class="page-title flex-wrap">
                        ...
                        <div>
                            ...
                            <a href="" target="_blank" type="button" href="#" id="exportPDF" class="btn btn-rounded btn-info">
                                <span class="btn-icon-start text-info"><i class="fa fa-file color-info"></i>Exporter en PDF</span>

                            </a>


                            <a href="" target="_blank" type="button" href="#" id="exportExcel" class="btn btn-rounded btn-info">
                                        ...
                                        <div class="d-flex">
                                            <div class="dropdown custom-dropdown ">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    <a class="dropdown-item detailOffre" href="" data-id="{{$souscription['id']}}">Voir les paiements  </a>


                                                     <a class="dropdown-item modifierOffre" href="" data-id="{{$souscription['id']}}">Modifier offre </a>
