        ...
        <div class="container-fluid">
            <div class="row">
                ...
                @php
                    ...
                    $total = Paiement::getTotal($annee_id, $compte_id);
                    $total_mois = Paiement::getTotal($annee_id, $compte_id, null, null, null, $debutmois, $finmois);
                    $total_semaine = Paiement::getTotal(
                        $annee_id,
                        $compte_id,
                        null,
                        null,
                    ...
                    $total_jour = Paiement::getTotal($annee_id, $compte_id, null, null, null, $aujourdhui);

                    $total_decaissement = Mouvement::getTotal(
                        $annee_id,
                        null,
                        $compte_id,
                        null,
                        \App\Types\TypeMouvement::DECAISSEMENTS,
                    );
                    $total_decaissement_mois = Mouvement::getTotal(
                        $annee_id,
                        null,
                        $compte_id,
                        null,
                    ...
                    $total_decaissement_semaine = Mouvement::getTotal(
                        $annee_id,
                        null,
                        $compte_id,
                        null,
                    ...
                    $total_decaissement_jour = Paiement::getTotal(
                        $annee_id,
                        null,
                        $compte_id,
                        null,
                ...
                <div class="col-xl-3 col-xxl-3 col-sm-6">
                    <div class="card counter">
                        <div class="card-body d-flex align-items-center p-4">
                            ...
                            <div class="">
                                <h2 class="font-w600 1h-1 mb-0">{{ $total_semaine }}</h2>
                                <p class="mb-0">
                                    Cette semaine
                                </p>
                            </div>
                ...
                <div class="col-xl-3 col-xxl-3 col-sm-6">
                    <div class="card counter">
                        <div class="card-body d-flex align-items-center p-4">
                            ...
                            <div class="">
                                <h2 class="font-w600 1h-1 mb-0">{{ $total_decaissement }}</h2>
                                <p class="mb-0">
                                    Total decaissements
                                </p>
                            </div>
                ...
                <div class="col-xl-3 col-xxl-3 col-sm-6">
                    <div class="card counter">
                        <div class="card-body d-flex align-items-center p-4">
                            ...
                            <div class="">
                                <h2 class="font-w600 1h-1 mb-0">{{ $total_decaissement_mois }}</h2>
                                <p class="mb-0">
                                    Ce mois
                                </p>
                            </div>
                ...
                <div class="col-xl-3 col-xxl-3 col-sm-6">
                    <div class="card counter">
                        <div class="card-body d-flex align-items-center p-4">
                            ...
                            <div class="">
                                <h2 class="font-w600 1h-1 mb-0">{{ $total_decaissement_semaine }}</h2>
                                <p class="mb-0">
                                    Cette semaine
                                </p>
                            </div>
                ...
                <div class="col-xl-3 col-xxl-3 col-sm-6">
                    <div class="card counter">
                        <div class="card-body d-flex align-items-center p-4">
                            ...
                            <div class="">
                                <h2 class="font-w600 1h-1 mb-0">{{ $total_decaissement_jour }}</h2>
                                <p class="mb-0">
                                    Auhourdhui
                                </p>
                            </div>
